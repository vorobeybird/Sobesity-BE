...
from sobesity.domain.entities import SkillEntity, SkillFilterEnitity, SkillId, \
    QuestionEntity, QuestionFilterEnitity, QuestionId, \
    AnswerEntity, AnswerFilterEnitity, AnswerId
...
for skill in templates:
    ...
    for question_with_answers in questions_with_answers:
        ...
        question_to_create = [QuestionEntity(question_id=None, question=question,
        ...
        created_question = question_service.get_list(QuestionFilterEnitity(questions=[question]))
        ...
        for answer_with_right in answers_for_this_question:
            ...
            answers_to_create.append(AnswerEntity(answer_id=None, answer=answer_with_right['answer'],
                                                   right=right,
